...
from engine.scratch import train_one_epoch, evaluate


def get_args_parser():
    parser = argparse.ArgumentParser('Training for image classification from scratch', add_help=False)
    ...
    parser.add_argument('--log_dir', default=None, # './output_dir',
